...
#SBATCH --job-name=benchmark_fp16
...
#SBATCH --output=results/week01/benchmark_fp16_%j.out
#SBATCH --error=results/week01/benchmark_fp16_%j.err
...
echo "===== Running benchmark full benchmark ====="

srun "${PYTHON}" harness/benchmark_single_model.py
